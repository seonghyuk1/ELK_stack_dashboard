  ...
  return (
    <div>
      ...
      {count == 2 && (
        <div className={styles.Container}>
          <iframe
            src="https://kwhcclab.com:20561/app/dashboards#/view/af7dd580-970a-11ed-a59b-6d42b3274f2d?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-15d%2Cto%3Anow-14d))&hide-filter-bar=true"
            height="700"
            width="100%"
          ></iframe>
        </div>
      ...
      {count == 4 && (
        <div className={styles.Container}>
          <iframe
            src="https://kwhcclab.com:20561/app/dashboards#/view/79c15390-970f-11ed-a59b-6d42b3274f2d?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-15d%2Cto%3Anow-14d))&hide-filter-bar=true"
            height="700"
            width="100%"
          ></iframe>
        </div>
      ...
      {count == 5 && (
        <div className={styles.Container}>
          <iframe
            src="https://kwhcclab.com:20561/app/dashboards#/view/e4448de0-9796-11ed-a59b-6d42b3274f2d?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-15d%2Cto%3Anow-14d))&hide-filter-bar=true"
            height="700"
            width="100%"
          ></iframe>
        </div>
      ...
      {count == 6 && (
        <div className={styles.Container}>
          <iframe
            src="https://kwhcclab.com:20561/app/dashboards#/view/90620400-9c9b-11ed-a59b-6d42b3274f2d?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-15d%2Cto%3Anow-14d))&hide-filter-bar=true"
            height="700"
            width="100%"
          ></iframe>
        </div>
      ...
      {count == 7 && (
        <div className={styles.Container}>
          <iframe
            src="https://kwhcclab.com:20561/app/dashboards#/view/bcdc1730-9c84-11ed-a59b-6d42b3274f2d?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-15d%2Cto%3Anow-14d))&hide-filter-bar=true"
            height="600"
            width="800"
          ></iframe>
        </div>
      ...
      {count == 8 && (
        <div className={styles.Container}>
          <iframe
            src="https://kwhcclab.com:20561/app/dashboards#/view/a7a13fa0-9c9b-11ed-a59b-6d42b3274f2d?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-15d%2Cto%3Anow-14d))&hide-filter-bar=true"
            height="700"
            width="100%"
          ></iframe>
        </div>
      ...
      {count == 9 && (
        <div className={styles.Container}>
          <iframe
            src="https://kwhcclab.com:20561/app/dashboards#/view/bbe75f80-9c9b-11ed-a59b-6d42b3274f2d?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-15d%2Cto%3Anow-14d))&hide-filter-bar=true"
            height="700"
            width="100%"
          ></iframe>
        </div>
